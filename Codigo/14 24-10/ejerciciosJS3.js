...
/*   return arreglo.every(elemento => elemento === arreglo[0]) */
 ...
 const meses = ["Enero","Noviembre","Febrero"]
const mesesDelAño= (array) => {
  //Dado un array que contiene algunos meses del año desordenados, recorrer el array buscando los meses de 
  // "Enero", "Marzo" y "Noviembre", guardarlx|o en nuevo array y retornarlo.
 ...
 */
  ...
  if (array.indexOf("Enero")==-1 || array.indexOf("Marzo")==-1 || array.indexOf("Noviembre")==-1) {
    ...
    let arrayRespuesta = []
    arrayRespuesta.push("Enero","Marzo","Noviembre");
    return arrayRespuesta;
}
}
console.log (mesesDelAño(meses))

const maCien  = [90,101,102,200] 
